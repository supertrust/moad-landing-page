        ...
        <div className="w-[1170px] h-[3022px] flex-col justify-start items-start gap-6 inline-flex">
          ...
          <div className="flex-col justify-start items-start gap-2 flex">
            ...
            <div className="flex-col justify-start items-start gap-1 flex">
              ...
              <div className="w-[1170px] text-neutral-900 text-base font-normal font-['Pretendard'] leading-snug">
                ...
                이용하는 자를 말합니다.
                <br />
                "모드 광고주 웹"이라 함은 "광고주"의 광고 신청, 게재, 관리, 취소
                등을 위해 "회사"가 "광고주"에게 제공하는 서비스 페이지(홈페이지
                URL)를 말합니다.
                <br />
          ...
          <div className="flex-col justify-start items-start gap-2 flex">
            ...
            <div className="w-[1170px] text-neutral-900 text-base font-normal font-['Pretendard'] leading-snug">
              ...
              "모드(홈페이지 URL)"에 게시합니다.
              <br />
              "회사"가 본 약관을 개정하는 경우에는 적용 일자 및 개정 사유를
              명시하여 현행 약관과 함께 제1항의 방식에 따라 그 적용일자 칠(7)일
              이전부터 적용일자 전일까지 공지합니다. 다만 "광고주"에게 불리하게
              약관을 변경하는 경우에는 최소한 삼십(30)일 이상의 사전 유예기간을
              두고 공지합니다.
              <br />
              회사가 전항에 따라 개정약관을 공지 또는 통지하면서 "광고주"에게
              전항의 기간 내에 의사표시를 하지 않으면 동의한 것으로 본다는 뜻을
              명확하게 공지 또는 통지하였음에도 "광고주"가 명시적으로 거부의
              의사표시를 하지 아니한 경우 "광고주"가 개정약관에 동의한 것으로
              봅니다.
            </div>
          </div>
          <div className="h-[220px] flex-col justify-start items-start gap-2 flex">
            ...
            <div className="flex-col justify-start items-start gap-1 flex">
              <div className="w-[1170px] text-neutral-900 text-base font-normal font-['Pretendard'] leading-snug">
                {" "}
                "광고주"는 "회사"가 제공하는 다음의 "약관"의 내용에 동의를 한
                다음 "회사"가 정한 절차에 따라 이용 신청을 하고 "회사"가 이러한
              ...
              <div className="w-[1170px] text-neutral-900 text-base font-normal font-['Pretendard'] leading-snug">
                "회사"는 "광고주"가 다음의 각 호의 하나의 사유가 있을 경우 광고
                서비스 이용을 제한할 수 있습니다.
              </div>
              <div className="px-7 justify-start items-center gap-2.5 inline-flex">
                <div className="w-[1170px] text-neutral-900 text-base font-normal font-['Pretendard'] leading-snug">
                  1) 허위 정보를 기재하거나 "회사"가 제시한 내용을 기재하지 않은
                  경우
                  <br />
          ...
          <div className="h-[352px] flex-col justify-start items-start gap-2 flex">
            ...
            <div className="flex-col justify-start items-start gap-1 flex">
              <div className="w-[1170px] text-neutral-900 text-base font-normal font-['Pretendard'] leading-snug">
                ...
                광고 상품등을 "모드 광고센터" 에 공지하며 "광고주"는 광고 신청
                전에 이를 신중히 확인하여야 합니다.
                <br />
                "회사"는 "광고주"가 전항에 따라 "광고주"가 신청한 "광고" 및
                "광고소재"에 대하여 "회사"에서 정한 절차, 기준 및 방식에
                부합하는지 형식적인 여부만을 검수하는 것에 그치며 "광고"와 "광고
                소재"간의 실질적 권리 유효성, 범위 및 권리의 주체, 관련 계약 등
                실질적 관계에 대한 심사를 하지 않습니다. "회사"는 권리주장자의
                신고 또는 요청에 의한 "광고" 또는 "광고소재"의 취소, 삭제 또는
                일시 중지에 대해 일체의 책임을 지지 않으며 이는 권리주장자와
                "광고주"간에 해결되어야 합니다."회사"는 "회사"의 검수 승인을
                득한 광고를 "광고주"의 "광고소재"를 "광고매체"에 게재합니다.
                <br />
                ...
                해당하는 경우 "광고"의 게재를 제한 또는 중단할 수 있으며 광고
          ...
          <div className="flex-col justify-start items-start gap-2 flex">
            ...
            <div className="w-[1170px] text-neutral-900 text-base font-normal font-['Pretendard'] leading-snug">
              ...
              <br />
              "회사"는 수시로 "광고 서비스"의 품질 향상 및 "광고"의 효과 증대
          ...
          <div className="flex-col justify-start items-start gap-2 flex">
            ...
            <div className="w-[1170px] text-neutral-900 text-base font-normal font-['Pretendard'] leading-snug">
              ...
              <br />
              "광고주"는 "회사"에 실제로 연락이 가능한 전자우편,(휴대)전화번호,
              주소 등의 정보를 제공하고 해당 정보들을 최신으로 유지하여야
              하며,"회사"의 통지를 확인하여야 합니다.
              <br />
          ...
          <div className="flex-col justify-start items-start gap-2 flex">
            ...
            <div className="w-[1170px] text-neutral-900 text-base font-normal font-['Pretendard'] leading-snug">
              ...
              시작하지 않을 수 있습니다.
              <br />
              "회사"는 "회사"가 선택한 외부플랫폼 광고업체의 서버를 통해서,
