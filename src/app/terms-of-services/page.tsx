        ...
        <div className='w-[1170px] py-20 flex-col justify-start items-start gap-6 inline-flex'>
          <div className='flex-col justify-start items-start gap-2 flex'>
            ...
            <div className="w-[1170px] text-neutral-900 text-base font-normal font-['Pretendard'] leading-snug">
              ...
              효과적으로 집행될 수 있도록 대행사, 차주 간의 책무 관계를 명확히
              하는데 있습니다.
            </div>
          </div>
          <div className='flex-col justify-start items-start gap-2 flex'>
            ...
            <div className='flex-col justify-start items-start gap-1 flex'>
              ...
              <div className="w-[1170px] text-neutral-900 text-base font-normal font-['Pretendard'] leading-snug">
                1. 광고 (이하 광고 라고 함)라 함은 회사 가 광고주 가 신청한 광고
                상품(아래 정의)의 내용과 절차에 따라 광고주 (아래 정의) 의 광고
                소재 (아래 정의)를 광고매체 에 노출하는 것을 <br /> 말합니다.
                <br />
                2. 광고소재 라 함은 광고주 가 제작하여 광고매체에 등록한 상품
                설명, 상품 사진, 텍스트 또는 이미지 등 형태의 저작물을 말합니다.
                <br />
                3. 광고 상품 혹은 광고물 이라 함은 광고주 의 광고 소재 를
                광고매체 에 게재하기 위하여 회사 가 광고주 에게 판매하는 것으로
                광고 상품의 종류, 노출 형태, 위치 등 구체적 내용은 <br /> 광고
                상품 및 광고 별도로 제공되는 설명표(각 광고 상세에 게시)와
                ...
                주체를 뜻합니다.
                <br />
                7.모드 어플 이라 함은 광고주 가 신청한 광고 를 게재하고  회사 가
                차주 에게 게재된 광고 들을 노출하고, 제공하는 서비스
                페이지(홈페이지 URL)를 말합니다.
                <br />
                8. 광고의뢰 라 함은 모드 어플리케이션에서 차주 가 광고 진행을
                하기 이전에 회사 와 “광고”관련된 “광고”집행전 사항을 의뢰하며
                “광고”에 대한 상세 진행 내용들을 상담 할수있는 <br />
                기능입니다.
              </div>
            </div>
          </div>
          ...
          <div className='flex-col justify-start items-start gap-2 flex'>
            ...
            <div className="w-[1170px] text-neutral-900 text-base font-normal font-['Pretendard'] leading-snug">
              ...
              지켜진 익월 25일에 계좌이체로 차주 에게 지급한다. 25일이 휴일이나
              공휴일일 경우, 25일과 제일 가까운 앞선 일자 중, 공휴일과 휴일이
              아닌 날에 지급한다.
              <br />
              2. 차주 는 게시된 “광고”의 상세내용을 참고하여, 해당 “광고주”가
              요구한 사항들을 충족하여야 한다. 해당 사항들은 광고의뢰 를 통하여
              확인후 광고를 진행할지 말지 정할수 있다.
              <br />
          ...
          <div className='flex-col justify-start items-start gap-2 flex'>
            ...
            <div className="w-[1170px] text-neutral-900 text-base font-normal font-['Pretendard'] leading-snug">
              ...
              변경하였을 경우.
              <br />
              2. 광고 면 부착이 계약 개시일 이후 15일 이내에 완료되지 않을 경우.
              <br />
