        ...
        <div className='w-[1170px] py-20 flex-col justify-start items-start gap-6 inline-flex'>
          <div className='flex-col justify-start items-start gap-2 flex'>
            ...
            <div className="w-[1170px] text-neutral-900 text-base font-normal font-['Pretendard'] leading-snug">
              본 약관은 회원(모드의 서비스 약관에 동의한 자를 말하며 이하
              '회원'이라고 합니다.)이 모드(이하 '회사'라고 합니다.)가 제공하는
              웹페이지 및 '모드' (회사가 개발 운영 하는 모바일   애플리케이션을
              말합니다. 이하 '모바일앱'이라고 합니다.)의 서비스를 이용함에 있어
              회원과 회사의 권리 및 의무, 기타 제반 사항을 정하는 것을 목적으로
              합니다.
            </div>
          </div>
          <div className='flex-col justify-start items-start gap-2 flex'>
          ...
          <div className='flex-col justify-start items-start gap-2 flex'>
            ...
            <div className="w-[1170px] text-neutral-900 text-base font-normal font-['Pretendard'] leading-snug">
              ...
              약관을 모두 읽고 "동 의하기" 버튼을 클릭하였을 경우 본 약관의
              내용을 모두 읽고 이를 충분히 이해하였 으며, 그 적용에
              <br /> 동의한 것으로 봅니다.
              <br />
              ...
              '관계법령'이라 합니다)의 범위 내에서 본 약관을 개정할 수 있습니다.
              <br />
