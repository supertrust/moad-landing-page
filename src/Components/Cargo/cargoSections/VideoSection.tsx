...
import SectionBackground from '../../../Assets/cargoVideoSectionBg.png';
...
const VideoSection: React.FC<{ OnScrollDown: () => void; isInView: boolean }> = ({
    ...
    const sectionStyle = {
        background: `url(${SectionBackground.src}) center center / cover no-repeat`,
        backgroundSize : "cover",
    };

    return (
        <section
            className=' h-full flex flex-col  bg-cover overflow-hidden bg-center opacity-100 !bg-[#484B6D]'
            style={sectionStyle}>
            {/*<ColorNavbar />*/}
