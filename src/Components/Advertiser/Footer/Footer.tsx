...
const Footer = () => {
  const FooterListPage = [
    ...
    { id: 4, lable: "개인정보 수집 및 이용동의",href:"/personal-information-agreement" },
  ];
  const FooterItems = [
  ...
  return (
    <footer className="bg-white  h-[322px]">
      ...
      <div className="mt-[40px]">
        <ul className="ml-[135px]">
          {FooterItems.map((item) => (
            <li key={item.id} className="text-[#525866] text-[16px] font-['Pretendard'] ">
              {item.lable}
            </li>
          ))}
        </ul>
