...
const DropDownReveal = ({ data }: Props) => {
    ...
    return (
        <div className='flex flex-col w-full justify-center mt-16'>
            <div className='w-full  px-10  py-6  bg-slate-100 border border-zinc-200 flex-col justify-start items-end inline-flex relative '>
                ...
                <div className={`flex w-full overflow-hidden  duration-500 ease-in-out transition-all ${isOpen ? "opacity-100 h-auto mt-10" : "opacity-0 h-0"}`}>
                        ...
                        {data?.map((item, index) => (
                            <div
                                ...
                                className={`h-[49px] duration-300 ease-in-out w-full  p-4  border border-gray-300 justify-start items-center gap-2.5 flex 
                                            hover:bg-[#CACFD8] bg-white text-gray-100 hover:text-daisyBush-60 hover:font-bold
