            ...
            <section className='overflow-hidden pt-4 h-screen bg-[#101440]'>
                ...
                <div className='h-full grid grid-cols-2 relative gap-16 items-center pb-10 px-4 md:px-6 lg:px-10 xl:px-28'>
                    <div className='relative h-full'>
                        {stepsData.map((item) => (
                            <div key={item.id} className={`absolute z-20 top-0 left-0 w-full h-full transition-opacity duration-1000 ease-in-out ${item.step === currentStep ? 'opacity-100' : 'opacity-0'}`}>
